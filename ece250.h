...
namespace ece250 {
	...
	class Allocation {
		public:
			...
			Allocation(): address(0), size(0), is_array(false), deleted(false) {
				// empty
			}

			Allocation( void *a, size_t s, bool i ): address(a), size(s), is_array(i), deleted(false) {
				// empty
			}
	};
	...
	class HashTable {
		...
		public:
			...
			HashTable( int as ):array_size( as ), total_memory_alloc( 0 ), total_memory_deleted( 0 ), record(false) {
